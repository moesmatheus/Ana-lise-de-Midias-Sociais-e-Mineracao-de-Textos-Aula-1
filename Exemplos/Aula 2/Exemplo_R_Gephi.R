...
# Exemplo Interface R e Gephi

# adaptado de http://www.vesnam.com/Rblog/viznets2/
...
dataSet <- read.table("c:/temp/Exemplo3.txt", header = FALSE, sep = "\t")
...
write.gexf(nodes = nodes_df, edges = edges_df, nodesAtt = nodes_att,
           edgesAtt = edges_att, nodesVizAtt = nodes_att_viz,
           edgesVizAtt = edges_att_viz, defaultedgetype = "undirected",
           output = "c:/temp/Exemplo3.gexf")
